...
for times = 1:rounds
    ...
    clear amount_of_randoms
    different = [5,10,15]
    amount_of_randoms = different(times);
    ...
    clear means
    clearvars -except collection times means_length selection ...
        last_fidelity mean_iters mean_fidelities amount_of_randoms ...
        repeats qubits ranknum rank real fidelities x0
    repeats = 10;
    qubits = 2;
    ranknum = 1;
    rank = ranknum;
